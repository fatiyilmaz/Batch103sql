...
-- bir sorgununun sonucunu baska bir sorgu da kullanma 
...
SELECT isim, sehir FROM ogrenciler WHERE puan > (SELECT 
												MAX(taban_puanı) 
												FROM bolumler)
