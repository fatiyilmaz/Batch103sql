...
select avg (fiyat) from arac; --> avg , averaj demek yani ortalama anlamina gelir

select round (avg (fiyat)) from arac; --> kusuratsiz

select round (avg (fiyat),2) from arac; --> 2 kusuratli
...
select * from meslekler where id>5 limit 2; --> id degeri 5 den buyuk olan ilk 2 deger.
...
select * from meslekler offset 2 limit 5;  --> offset ilk iki veriyi atla demek
