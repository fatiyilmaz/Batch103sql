...
select sehir, count(isim) as personel_sayisi from personel1
group by sehir
having count (isim)>1
...
intersect -- Ortak nokta birlesimi
select isim from personel where sirket = 'Ford'
intersect
select isim from personel where sirket = 'Tofas'


--5000 den az maas alip Hondo da çalişmayanlari yazdirin
select isim from personel where maas<5000
except -- Dahil olmayanlar
select isim from personel where sirket = 'Honda'
