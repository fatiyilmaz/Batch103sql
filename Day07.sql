-- DISTINCT KULLANIMI
-- cagirilan terimlerden tekrarli olanlarin sadece birincisini alir.
CREATE TABLE maas 
(
id int, 
...
SELECT urun_isim, count (distinct urun_isim) FROM musteri_urun -- hepsi tek geldi
GROUP BY urun_isim
...
sirket varchar(20),
CONSTRAINT personel_fk PRIMARY KEY (id)
);
...
/*
	...
	* Transaction baslatmak icin Begin komutu kullanmamiz gerekir ve Transaction'i sonlandirmak icin Commit
	* komutunu calistirmaliyiz.
 */
...
id serial, -- Serial data turu otomatik olarak 1'den baslayarak sirali olarak sayi atamasi yapar.
	       -- Insert into ile tabloya veri eklerken serial data turunu kullandigim veri degeri 
	       -- yerine default yazariz.
isim VARCHAR(50),
